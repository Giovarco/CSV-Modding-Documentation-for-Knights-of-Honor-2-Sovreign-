...
| `CTH_shoot_mod` | Float | Modifier applied to CTH when this unit is being shot at by ranged units. |
| `CTH_cavalry_mod` | Float | Modifier to CTH when this unit faces cavalry. |
| `naval_CTH_perc` | Float | Percentage modifier to CTH in naval combat. |
| `chance_to_shock` | Float | Probability of causing a morale shock to the enemy on a successful hit. |
...
Use this checklist to track documentation progress across sessions.
...
- [x] **2.7** CoA.csv
- [x] **2.8** papacy.csv
- [x] **2.9** geo_features.csv
- [x] **2.10** properties.csv
- [x] **2.11** CheapBuildings.csv
- [x] **2.12** CheapMilitia.csv
- [x] **3.1** languages.csv
- [x] **3.2** preload.csv and language variants
- [x] **3.3** teritories.csv and language variants
- [x] **3.4** character_names.csv and language variants
- [x] **3.5** cultures localisation
- [x] **3.6** factions localisation
- [x] **3.7** kingdom_descriptions.csv
- [x] **3.8** Vassalage.csv and language variants
- [x] **3.9** UnionQuess.csv and language variants
- [x] **3.10** Building name localisation files
- [x] **3.11** Unit name localisation files
- [x] **3.12** Knight class localisation files
- [x] **3.13** Goods localisation files
- [x] **3.14** Opinion localisation files
- [x] **3.15** Religion localisation files
- [x] **3.16** Religious titles localisation files
- [x] **3.17** Settlement type localisation files
- [x] **3.18** Kingdom type localisation files
- [x] **3.19** Nobility title localisation files
- [x] **3.20** Character age localisation files
- [x] **3.21** Fantasy name localisation files
- [x] **3.22** Inventory item localisation files
- [x] **3.23** Nobility/title extended localisation (de_, pl_)
- [x] **3.24** de_ miscellaneous files
- [x] **4.1** VO.csv
- [x] **4.2** Narrator voice lines.csv
- [x] **4.3** Knights voice lines.csv
- [x] **4.4** Units voice lines.csv
- [x] **4.5** ADDITIONS variants
- [x] **4.6** VIRTUAL variants
- [x] **5** Duplicate / backup files reference
